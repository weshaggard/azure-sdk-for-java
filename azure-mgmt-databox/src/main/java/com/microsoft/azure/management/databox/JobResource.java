...
public interface JobResource extends HasInner<JobResourceInner>, Resource, GroupableResourceCore<DataBoxManager, JobResourceInner>, HasResourceGroup, Refreshable<JobResource>, Updatable<JobResource.Update>, HasManager<DataBoxManager> {
     ...
     */
    interface Update extends Appliable<JobResource>, Resource.UpdateWithTags<Update>, UpdateStages.WithDestinationAccountDetails, UpdateStages.WithDetails {
    }
    ...
    interface UpdateStages {
        /**
         * The stage of the jobresource {0} allowing to specify DestinationAccountDetails.
         */
        ...
        /**
         * The stage of the jobresource {0} allowing to specify Details.
         */
        interface WithDetails {
            /**
             * Specifies details.
