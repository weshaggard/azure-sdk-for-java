 ...
 */
public interface NamespaceSharedAccessAuthorizationRuleResource extends HasInner<SharedAccessAuthorizationRuleResourceInner>, Indexable, Updatable<NamespaceSharedAccessAuthorizationRuleResource.Update>, HasManager<NotificationHubsManager> {
    /**
     * @return the id value.
     */
    String id();
